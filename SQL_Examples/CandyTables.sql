...
username VARCHAR(30),
password VARCHAR(8),
CONSTRAINT candy_customer_cust_type_fk FOREIGN KEY (cust_type) REFERENCES 
candy_cust_type(cust_type));
...
CREATE TABLE candy_purchase(
  ...
  pounds FLOAT,
  status VARCHAR(10),
  CONSTRAINT candy_purchase_prod_id_fk FOREIGN KEY (prod_id) REFERENCES 
candy_product(prod_id),
  CONSTRAINT candy_customer_cust_id_fk FOREIGN KEY (cust_id) REFERENCES 
...
INSERT INTO candy_customer (cust_name, cust_type, cust_addr, cust_zip, cust_phone, 
username, password) VALUES
('Joe Jones', 'P', '1234 Main Street', '91212', '434-1231', 'jonesj', '1234');
INSERT INTO candy_customer (cust_name, cust_type, cust_addr, cust_zip, cust_phone, 
username, password) VALUES
('Armstrong, Inc.', 'R', '231 Globe Blvd', '91212', '434-7664', 'armstrong', 
'3333');
INSERT INTO candy_customer (cust_name, cust_type, cust_addr, cust_zip, cust_phone, 
username, password) VALUES
('Swedish Burgers', 'R', '1889 20th N.E.', '91213', '434-9090', 'swedburg', 
'2353');
INSERT INTO candy_customer (cust_name, cust_type, cust_addr, cust_zip, cust_phone, 
username, password) VALUES
...
INSERT INTO candy_customer (cust_name, cust_type, cust_addr, cust_zip, cust_phone, 
username, password) VALUES
('Columberg Sweets', 'W', '239 East Falls', '91209', '874-9092', 'columswe', 
'8399');
-- insert values into candy_product
INSERT INTO candy_product (prod_desc, prod_cost, prod_price) VALUES('Celestial 
Cashew Crunch', 7.45, 10);
INSERT INTO candy_product (prod_desc, prod_cost, prod_price) VALUES('Unbrittle 
Peanut Paradise', 5.75, 9);
INSERT INTO candy_product (prod_desc, prod_cost, prod_price) VALUES('Mystery 
Melange', 7.75, 10.50);
INSERT INTO candy_product (prod_desc, prod_cost, prod_price) VALUES('Millionaire''s
Macadamia Mix', 12.50, 16);
INSERT INTO candy_product (prod_desc, prod_cost, prod_price) VALUES('Nuts Not Nachos', 6.25, 9.50);
INSERT INTO candy_product (prod_desc, prod_cost, prod_price) VALUES('Chocolate 
Excess', 15.25, 20.50);
...
INSERT INTO candy_purchase VALUES (5, 1, 7, '2007-9-6', '2007-9-6', 3.7, 'NOT 
PAID');
INSERT INTO candy_purchase VALUES (5, 2, 7, '2007-9-6', '2007-9-6', 1.2, 'NOT 
PAID');
INSERT INTO candy_purchase VALUES (5, 3, 7, '2007-9-7', '2007-9-7', 4.4, 'NOT 
PAID');
...
INSERT INTO candy_purchase VALUES (9, 5, 4, '2007-9-7', '2007-9-8', 3.5, 'NOT 
PAID');
